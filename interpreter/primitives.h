...
object_t primitive_read_char(object_t);
object_t primitive_string_length(object_t);
object_t primitive_string_equals(object_t);
object_t primitive_string_ref(object_t);
